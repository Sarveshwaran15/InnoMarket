...
public partial class Purchased_Details_Vendor : System.Web.UI.Page
{
    ...
    protected void BindGridView()
    {
        ...
        string query = "SELECT o.ProductID, p.product_name, o.quantity, o.total, p.vendor_id FROM Orders o INNER JOIN Product p ON o.ProductID = p.product_id where vendor_id='" + vendorID + "'";
    ...
    void display()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT o.purchase_id, o.productname,v.vendor_name,o.quantity,o.total,o.DateField FROM orders o INNER JOIN vendor v ON o.vendorid = v.vendor_id WHERE o.vendorid = 'VID4'", con);
    ...
    protected void loaddata(string filter)
    {
        // string connectionString = "YourConnectionString"; // Replace this with your actual connection string
        // string connectionString = "YourConnectionString"; // Replace this with your actual connection string
        string query = "SELECT o.product_id, p.product_name, o.quantity, o.total, p.vendor_id FROM Orders o INNER JOIN Product p ON o.product_id = p.product_id";
    ...
    protected void BindGridViewd(string filter, DateTime startDate, DateTime endDate)
    {
        ...
        query += " AND p.product_date BETWEEN @StartDate AND @EndDate";
